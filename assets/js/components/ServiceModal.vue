<template>
    <div class="modal fade" id="serviceModal" tabindex="-1" aria-labelledby="serviceModalLabel" aria-hidden="true" ref="modal" :services="services">
            ...
            <div class="modal-content">
                ...
                >
                    <div class="modal-header">
                        <h5 class="modal-title mt-4" id="serviceModalLabel">Получение услуг</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-32">
                            <vSelect
                                ...
                                :newServices="getServices"
                                rules="required"
                                v-model="form.service_service"
                            >
                            </vSelect>
                        </div>
                        <div class="mb-32 form-check">
                            ...
                            <label class="form-check-label ms-3" for="exampleCheck1">
                                ...
                                <a href="/user-agreement" class="d-block">
                                    персональных данных
                                </a>
                            </label>
                        </div>
                        <button
                            type="submit"
                            class="btn btn-secondary btn-modal mb-4"
                        ...
                        >
                            ...
                            <b>Заказать звонок</b>
                            <span class="spinner-border spinner-border-sm fw-light ps-2" role="status" v-if="isLoading">
...
export default {
    ...
    computed: {
      getServices() {
          return this.services.map(e => ({label: e, value: e}));
        }
    },
    mounted() {
